...
import org.whole.crossexamples.lwc16.mjcflow.model.IMJCFlowEntity;
import org.whole.crossexamples.lwc16.mjcflow.model.UnlessStatement;
import org.whole.crossexamples.lwc16.mjcflow.visitors.MJCFlowIdentityDefaultVisitor;
 ...
 * @generator Whole
 */
public class MJCFlowPartFactoryVisitor extends MJCFlowIdentityDefaultVisitor implements IEditPartFactory {
	protected EditPart part, context;

	public EditPart createEditPart(EditPart context, Object modelEntity) {
		this.context = context;
		((IMJCFlowEntity) modelEntity).accept(this);
		return part;
	}
