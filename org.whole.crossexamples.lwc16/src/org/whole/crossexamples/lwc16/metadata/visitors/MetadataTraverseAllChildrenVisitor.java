 ...
 * @generator Whole
 */
public class MetadataTraverseAllChildrenVisitor extends MetadataIdentityUnaryVisitor<IMetadataVisitor> {
	public MetadataTraverseAllChildrenVisitor() {
		wSetVisitor1(this);
	}

	public MetadataTraverseAllChildrenVisitor(IVisitor visitor1) {
		super(visitor1);
	}
