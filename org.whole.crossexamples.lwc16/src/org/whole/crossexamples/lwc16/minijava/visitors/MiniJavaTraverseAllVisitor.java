 ...
 * @generator Whole
 */
public class MiniJavaTraverseAllVisitor extends MiniJavaIdentityUnaryVisitor<IMiniJavaVisitor> {
	public MiniJavaTraverseAllVisitor() {
		wSetVisitor1(this);
	}

	public MiniJavaTraverseAllVisitor(IVisitor visitor1) {
		super(visitor1);
	}
