 ...
 * @generator Whole
 */
public class MiniJavaIdentityUnaryVisitor<V extends IVisitor> extends AbstractUnaryVisitor<V>
		implements IMiniJavaVisitor {
	public MiniJavaIdentityUnaryVisitor() {
		super(null);
	}

	public MiniJavaIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
